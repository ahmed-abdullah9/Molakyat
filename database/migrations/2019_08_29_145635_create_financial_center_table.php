...
class CreateFinancialCenterTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('financial_center', function (Blueprint $table) {
            ...
            $table->double('currentـliabilities1')->nullable(); // from 60 to 61
            $table->double('currentـliabilities2')->nullable();
            $table->double('currentـliabilities_special47')->nullable(); //from line 62 to 82 
            ...
            $table->double('current_tax_liabilities1')->nullable();// from line 84 - 85
            $table->double('current_tax_liabilities2')->nullable();
            $table->double('liabilities_directly')->nullable(); // line 88 
            $table->double('non_current_liabilities1')->nullable(); // from line 91 - 92
            $table->double('non_current_liabilities2')->nullable();
            $table->double('total_non_current_liabilities1')->nullable(); // from line 93 - 107
            ...
            $table->double('property_rights1')->nullable(); // from line 111 - 118
            ...
            $table->double('other_reserves1')->nullable();// from line 120 - 127
