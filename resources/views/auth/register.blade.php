...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right">{{ __('تسجيل') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('postRegister') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required autofocus>
