        ...
        <div class="tab-pane fade" id="completed">
            <table class="table table-bordered spec-table">
                ...
                <tr class="orientation">
                    ...
                    <td class="list"> حصة الدخل الشامل الآخر من شركات زميلة ومشاريع مشتركة تمت المحاسبة عنها باستخدام طريقة حقوق الملكية التي لن يعاد تصنيفها<br> إلى الربح أو الخسارة، صافي بعد الضريبة</td>
                    ...
                    <td class="list"> حصة الدخل الشامل الآخر من شركات زميلة ومشاريع مشتركة تمت المحاسبة عنها باستخدام طريقة حقوق الملكية <br> والتي سيعاد تصنيفها إلى الربح أو الخسارة، صافي بعد الضريبة</td>
